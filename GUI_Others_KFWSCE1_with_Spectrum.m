function varargout = GUI_Others_KFWSCE1_with_Spectrum(varargin)
% GUI_OTHERS_KFWSCE1_WITH_SPECTRUM MATLAB code for GUI_Others_KFWSCE1_with_Spectrum.fig
%      GUI_OTHERS_KFWSCE1_WITH_SPECTRUM, by itself, creates a_input new GUI_OTHERS_KFWSCE1_WITH_SPECTRUM or raises the existing
%      singleton*.
%
%      H = GUI_OTHERS_KFWSCE1_WITH_SPECTRUM returns the handle to a_input new GUI_OTHERS_KFWSCE1_WITH_SPECTRUM or the handle to
%      the existing singleton*.
%
%      GUI_OTHERS_KFWSCE1_WITH_SPECTRUM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_OTHERS_KFWSCE1_WITH_SPECTRUM.M with the given input arguments.
%
%      GUI_OTHERS_KFWSCE1_WITH_SPECTRUM('Property','Value',...) creates a_input new GUI_OTHERS_KFWSCE1_WITH_SPECTRUM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_Others_KFWSCE1_with_Spectrum_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_Others_KFWSCE1_with_Spectrum_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_Others_KFWSCE1_with_Spectrum

% Last Modified by GUIDE v2.5 07-Oct-2019 14:11:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_Others_KFWSCE1_with_Spectrum_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Others_KFWSCE1_with_Spectrum_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Others_KFWSCE1_with_Spectrum is made visible.
function GUI_Others_KFWSCE1_with_Spectrum_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_Others_KFWSCE1_with_Spectrum (see VARARGIN)

% Choose default command line output for GUI_Others_KFWSCE1_with_Spectrum
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_Others_KFWSCE1_with_Spectrum wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Others_KFWSCE1_with_Spectrum_OutputFcn(hObject, eventdata, handles) 
...
function rw_input_Callback(hObject, eventdata, handles)
% hObject    handle to rw_input (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of rw_input as text
%        str2double(get(hObject,'String')) returns contents of rw_input as a double


% --- Executes during object creation, after setting all properties.
function rw_input_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rw_input (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
rw = str2double(get(handles.rw_input,'String'))/1000;
L = str2double(get(handles.L_input,'String'))/1000;
...
wtb = waitbar(0,'KFWSCE1 calculation is running, please wait');
...
while (KI_max_0 <= KIC) && (KI_max_90 <= KIC);      
    ...
    if W >= (c + t);
        alpha_coef = (a/t)/(1 + t/c);
    else
        alpha_coef = (a/t)*(c/W);
    end

    g = 1 - 20*(a/(2*c))^0.75*alpha_coef^3;
    sigma_ref = (g*sigma_b_max + ((g*sigma_b_max)^2 + 9*sigma_m_max^2*(1 - alpha_coef)^2)^0.5)/(3*(1 - alpha_coef)^2);
    ...
    [KI_max_0, KI_min_0, KI_max_90, KI_min_90] = KFWSCE1(a, c, t, rw, W, L, pc_max, pc_min, alpha, beta_0, beta_90, sigma_m_max, sigma_m_min, sigma_b_max, sigma_b_min);
...
ttl = {'Iteration', 'Time (Hour)', 'a (mm)', 'c (mm)', 'KI max a (MPa.m^0.5)', 'KI max c (MPa.m^0.5)'};
