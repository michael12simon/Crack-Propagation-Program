function varargout = GUI_Plate_KPECE2_with_Spectrum(varargin)
% GUI_PLATE_KPECE2_WITH_SPECTRUM MATLAB code for GUI_Plate_KPECE2_with_Spectrum.fig
%      GUI_PLATE_KPECE2_WITH_SPECTRUM, by itself, creates a_input new GUI_PLATE_KPECE2_WITH_SPECTRUM or raises the existing
%      singleton*.
%
%      H = GUI_PLATE_KPECE2_WITH_SPECTRUM returns the handle to a_input new GUI_PLATE_KPECE2_WITH_SPECTRUM or the handle to
%      the existing singleton*.
%
%      GUI_PLATE_KPECE2_WITH_SPECTRUM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_PLATE_KPECE2_WITH_SPECTRUM.M with the given input arguments.
%
%      GUI_PLATE_KPECE2_WITH_SPECTRUM('Property','Value',...) creates a_input new GUI_PLATE_KPECE2_WITH_SPECTRUM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_Plate_KPECE2_with_Spectrum_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_Plate_KPECE2_with_Spectrum_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_Plate_KPECE2_with_Spectrum

% Last Modified by GUIDE v2.5 26-Sep-2019 11:22:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_Plate_KPECE2_with_Spectrum_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Plate_KPECE2_with_Spectrum_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Plate_KPECE2_with_Spectrum is made visible.
function GUI_Plate_KPECE2_with_Spectrum_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_Plate_KPECE2_with_Spectrum (see VARARGIN)

% Choose default command line output for GUI_Plate_KPECE2_with_Spectrum
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_Plate_KPECE2_with_Spectrum wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Plate_KPECE2_with_Spectrum_OutputFcn(hObject, eventdata, handles) 
...
%        str2double(get(hObject,'String')) returns contents of W_input as a_input double
...
wtb = waitbar(0,'KPECE2 calculation is running, please wait');
...
while KI_max_0 <= KIC &&  KI_max_90 <= KIC && KI_max <= KIC;
    ...
    if embedded == true;    
        ...
        [KI_max_90,KI_max_0,KI_min_90,KI_min_0]= KPECE2(a, c, d1, t, W, beta_0, beta_90, sigma0_max, sigma1_max, sigma2_max, sigma3_max, sigma4_max, sigma0_min, sigma1_min, sigma2_min, sigma3_min, sigma4_min);
        if spectrum_load == 1;
    ...
    %SURFACE CRACK CALCULATION
        ...
        % Stress Intensity Calculation
        d = t - a;
        beta_0 = beta0 + beta1*0/t + beta2*(0/t)^2 + beta3*(0/t)^3 + beta4*(0/t)^4 + beta5*(0/t)^5;
        beta_90 = beta0 + beta1*d/t + beta2*(d/t)^2 + beta3*(d/t)^3 + beta4*(d/t)^4 + beta5*(d/t)^5;    
        [KI_max_0, KI_min_0, KI_max_90, KI_min_90] = KPSCE2(a, c, t, W, beta_0, beta_90, pc_max, pc_min, sigma0_max, sigma1_max, sigma2_max, sigma3_max, sigma4_max, sigma0_min, sigma1_min, sigma2_min, sigma3_min, sigma4_min);
        if spectrum_load == 1;
            [da_paris, dc_paris] = Paris(C, m, KTH, KI_max, KI_min, KI_max_0, KI_min_0, KI_max_90, KI_min_90, crack);
            c = c + dc_paris;
            a = a + da_paris;
