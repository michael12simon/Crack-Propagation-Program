function varargout = GUI_Others_KNCC1_with_Spectrum(varargin)
% GUI_OTHERS_KNCC1_WITH_SPECTRUM MATLAB code for GUI_Others_KNCC1_with_Spectrum.fig
%      GUI_OTHERS_KNCC1_WITH_SPECTRUM, by itself, creates a_input new GUI_OTHERS_KNCC1_WITH_SPECTRUM or raises the existing
%      singleton*.
%
%      H = GUI_OTHERS_KNCC1_WITH_SPECTRUM returns the handle to a_input new GUI_OTHERS_KNCC1_WITH_SPECTRUM or the handle to
%      the existing singleton*.
%
%      GUI_OTHERS_KNCC1_WITH_SPECTRUM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_OTHERS_KNCC1_WITH_SPECTRUM.M with the given input arguments.
%
%      GUI_OTHERS_KNCC1_WITH_SPECTRUM('Property','Value',...) creates a_input new GUI_OTHERS_KNCC1_WITH_SPECTRUM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_Others_KNCC1_with_Spectrum_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_Others_KNCC1_with_Spectrum_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_Others_KNCC1_with_Spectrum

% Last Modified by GUIDE v2.5 04-Oct-2019 14:10:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_Others_KNCC1_with_Spectrum_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Others_KNCC1_with_Spectrum_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Others_KNCC1_with_Spectrum is made visible.
function GUI_Others_KNCC1_with_Spectrum_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_Others_KNCC1_with_Spectrum (see VARARGIN)

% Choose default command line output for GUI_Others_KNCC1_with_Spectrum
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_Others_KNCC1_with_Spectrum wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Others_KNCC1_with_Spectrum_OutputFcn(hObject, eventdata, handles) 
...
function sigma_corner_max_input_Callback(hObject, eventdata, handles)
% hObject    handle to sigma_corner_max_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sigma_corner_max_input as text
%        str2double(get(hObject,'String')) returns contents of sigma_corner_max_input as a_input double


% --- Executes during object creation, after setting all properties.
function sigma_corner_max_input_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sigma_corner_max_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
...
function sigma_corner_min_input_Callback(hObject, eventdata, handles)
% hObject    handle to sigma_corner_min_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sigma_corner_min_input as text
%        str2double(get(hObject,'String')) returns contents of sigma_corner_min_input as a_input double


% --- Executes during object creation, after setting all properties.
function sigma_corner_min_input_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sigma_corner_min_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function sigma_nom_max_input_Callback(hObject, eventdata, handles)
% hObject    handle to sigma_nom_max_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sigma_nom_max_input as text
%        str2double(get(hObject,'String')) returns contents of sigma_nom_max_input as a_input double


% --- Executes during object creation, after setting all properties.
function sigma_nom_max_input_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sigma_nom_max_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% hObject    handle to sigma_nom_min_input (see GCBO)
% eventdata  reserved - to be defined in a_input future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sigma_nom_min_input as text
%        str2double(get(hObject,'String')) returns contents of sigma_nom_min_input as a_input double
...
% hObject    handle to Pm_input (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Pm_input as text
%        str2double(get(hObject,'String')) returns contents of Pm_input as a double
...
sigma_corner_max = str2double(get(handles.sigma_corner_max_input,'String'));
sigma_corner_min = str2double(get(handles.sigma_corner_min_input,'String'));
sigma_nom_max = str2double(get(handles.sigma_nom_max_input,'String'));
sigma_nom_min = str2double(get(handles.sigma_nom_min_input,'String'));
pc_max = str2double(get(handles.pc_max_input,'String'));
pc_min = str2double(get(handles.pc_min_input,'String'));
Pm = str2double(get(handles.Pm_input,'String'));
...
plate = get(handles.plate_cond,'Value');
cylindrical = get(handles.cylindrical_cond,'Value');
spherical = get(handles.spherical_cond,'Value');
spectrum_load = get(handles.spectrum_load_cond,'Value');

% Initial Condition
crack = 1; % Using Membrane and Bending Stress Calc in KCTCL
startup = true; 
i = 1; n = 1; z = 0;
total_time = 0;
KI_max = 0;
...
wtb = waitbar(0,'KNCC1 calculation is running, please wait');
...
pc_max_0 = pc_max;
pc_min_0 = pc_min;
sigma_nom_max_0 = sigma_nom_max;
sigma_nom_min_0 = sigma_nom_min;
sigma_corner_max_0 = sigma_corner_max;
sigma_corner_min_0 = sigma_corner_min;
Pm_0 = Pm;
...
while KI_max <= KIC;
    ...
    if spectrum_load == 1;
        ...
        if (2*i - 1) >= (z + 1)*spectrum_rows;
            if spectrum(spectrum_rows,2) > spectrum(1,2);
                pc_max = pc_max_0*spectrum((2*i - 1 - z*spectrum_rows),2)/spectrum(2,2);
                pc_min = pc_min_0*spectrum(1,2)/spectrum(2,2);
                sigma_nom_max = sigma_nom_max_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
                sigma_nom_min = sigma_nom_min_0*spectrum(1,2)/spectrum(2,2);
                sigma_corner_max = sigma_corner_max_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
                sigma_corner_min = sigma_corner_min_0*spectrum(1,2)/spectrum(2,2);
                Pm = Pm_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
            else
                i = i + 1;
        ...
        elseif i > 1 || (2*i) == (z + 1)*spectrum_rows;
            pc_max = pc_max_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
            pc_min = pc_min_0*spectrum((2*i - 1 - z*spectrum_rows),2)/spectrum(2,2);
            sigma_nom_max = sigma_nom_max_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
            sigma_nom_min = sigma_nom_min_0*spectrum((2*i - 1 - z*spectrum_rows),2)/spectrum(2,2);  
            sigma_corner_max = sigma_corner_max_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);
            sigma_corner_min = sigma_corner_min_0*spectrum((2*i - 1 - z*spectrum_rows),2)/spectrum(2,2);  
            Pm = Pm_0*spectrum((2*i - z*spectrum_rows),2)/spectrum(2,2);       
        end
    end
    ...
    sigma_ref = Pm*((2.5*tn^2 + (q - rn)*t)/(2.5*tn^2 + (q - rn)*t - 0.25*pi*a^2));
        
    % Stress Intensity Calculation
    d1 = tn - a;
    beta = beta0 + beta1*d1/tn + beta2*(d1/tn)^2 + beta3*(d1/tn)^3 + beta4*(d1/tn)^4 + beta5*(d1/tn)^5;
    [KI_max, KI_min] = KNCC1(a, t, tn, dn, beta, pc_max, pc_min, sigma_nom_max, sigma_nom_min, sigma_corner_max, sigma_corner_min, plate, cylindrical, spherical);
